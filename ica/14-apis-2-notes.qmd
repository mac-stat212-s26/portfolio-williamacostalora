...
> It is constructing a URL to the U.S. Census API, sending an HTTP request, and then parsing the response into a tidy dataset.
...
```{r nyt_ex3}
#| eval: false
resp_pt$response$docs |> select(abstract, lead_paragraph)
```
