...
```{r}
nih_stem <- read_html("https://science.education.nih.gov/")

# Extract resource titles
resource_titles <- nih_stem |>
  html_elements(".resource-title") |>
  html_text()

head(resource_titles)

resource_links <- nih_stem |>
  html_elements(".resource-title a") |>
  html_attr("href")
