...
```{r plotly_static_example, eval=FALSE}
#| eval: false
...
```{r plotly_animation_example, eval=FALSE}
...
## Neighborhood Diversity Shiny App

Explore neighborhood diversity across U.S. cities interactively. Use the dropdown to select a city and the slider to adjust the smoothing span of the diversity-vs-distance curve.

<iframe src="https://1wrn0x-liam-acosta0lora.shinyapps.io/shinyICA/" 
        width="100%" 
        height="800px" 
        frameborder="0">
</iframe>
